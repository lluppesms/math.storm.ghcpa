...
var connectionString = !empty(sqlAdminPassword)
  ? 'Server=tcp:${sqlServerName}.database.windows.net,1433;Initial Catalog=${sqlDBName};User Id=${sqlAdminUser};******;Encrypt=True;TrustServerCertificate=False;Connection Timeout=120;'
