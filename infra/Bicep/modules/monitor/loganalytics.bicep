...
output appInsightsInstrumentationKey string = useExistingAppInsights ? existingApplicationInsightsResource.properties.InstrumentationKey : newApplicationInsightsResource.properties.InstrumentationKey
