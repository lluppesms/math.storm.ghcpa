...
{
    private MockDataService _dataService = null!;
    ...
    public async Task AddToLeaderboard_FirstEntry_ShouldAddSuccessfully()
    {
        ...
        // Act
        var result = await _dataService.AddToLeaderboardAsync(userId, username, gameId, difficulty, score);
    ...
    public async Task AddToLeaderboard_SecondEntry_ShouldAddSuccessfully()
    {
        ...
        // Add first entry
        await _dataService.AddToLeaderboardAsync(userId, username, "game1", difficulty, 50.0);

        // Act - Add second entry with better score
        var result = await _dataService.AddToLeaderboardAsync(userId, username, "game2", difficulty, 40.0);

        // Assert
        Assert.IsNotNull(result);
        var leaderboard = await _dataService.GetLeaderboardAsync(difficulty, 10);
    ...
    public async Task AddToLeaderboard_ThirdEntry_ShouldAddSuccessfully()
    {
        ...
        // Add two entries
        await _dataService.AddToLeaderboardAsync(userId, username, "game1", difficulty, 50.0);
        await _dataService.AddToLeaderboardAsync(userId, username, "game2", difficulty, 40.0);

        // Act - Add third entry
        var result = await _dataService.AddToLeaderboardAsync(userId, username, "game3", difficulty, 45.0);
    ...
    public async Task AddToLeaderboard_FourthEntryWorse_ShouldNotAdd()
    {
        ...
        await _dataService.AddToLeaderboardAsync(userId, username, "game1", difficulty, 30.0);
        await _dataService.AddToLeaderboardAsync(userId, username, "game2", difficulty, 40.0);
        await _dataService.AddToLeaderboardAsync(userId, username, "game3", difficulty, 50.0);

        // Act - Try to add fourth entry with worse score (60 > 50)
        var result = await _dataService.AddToLeaderboardAsync(userId, username, "game4", difficulty, 60.0);
    ...
    public async Task AddToLeaderboard_FourthEntryBetter_ShouldReplaceWorst()
    {
        ...
        var result = await _dataService.AddToLeaderboardAsync(userId, username, "game4", difficulty, 35.0);
    ...
    public async Task AddToLeaderboard_CaseInsensitiveUsername_ShouldEnforceLimit()
    {
        ...
        await _dataService.AddToLeaderboardAsync(userId, "TestUser", "game1", difficulty, 30.0);
        await _dataService.AddToLeaderboardAsync(userId, "testuser", "game2", difficulty, 40.0);
        await _dataService.AddToLeaderboardAsync(userId, "TESTUSER", "game3", difficulty, 50.0);

        // Act - Try to add fourth entry with different case (should still count towards limit)
        var result = await _dataService.AddToLeaderboardAsync(userId, "TeStUsEr", "game4", difficulty, 60.0);
    ...
    public async Task AddToLeaderboard_MultipleUsers_ShouldEnforceLimitPerUser()
    {
        ...
        await _dataService.AddToLeaderboardAsync("user1", "Alice", "game1", difficulty, 30.0);
        await _dataService.AddToLeaderboardAsync("user1", "Alice", "game2", difficulty, 40.0);
        await _dataService.AddToLeaderboardAsync("user1", "Alice", "game3", difficulty, 50.0);

        // User 2: Add two entries
        await _dataService.AddToLeaderboardAsync("user2", "Bob", "game4", difficulty, 35.0);
        await _dataService.AddToLeaderboardAsync("user2", "Bob", "game5", difficulty, 45.0);

        // Act - User 2 should be able to add third entry
        var bobResult = await _dataService.AddToLeaderboardAsync("user2", "Bob", "game6", difficulty, 55.0);

        // User 1 should not be able to add fourth worse entry
        var aliceResult = await _dataService.AddToLeaderboardAsync("user1", "Alice", "game7", difficulty, 60.0);
    ...
    public async Task AddToLeaderboard_DifferentDifficulties_ShouldAllowThreePerDifficulty()
    {
        ...
        await _dataService.AddToLeaderboardAsync(userId, username, "game1", "Expert", 30.0);
        await _dataService.AddToLeaderboardAsync(userId, username, "game2", "Expert", 40.0);
        await _dataService.AddToLeaderboardAsync(userId, username, "game3", "Expert", 50.0);

        // Act - Add three entries for "Beginner" difficulty (should be allowed)
        var result1 = await _dataService.AddToLeaderboardAsync(userId, username, "game4", "Beginner", 35.0);
        var result2 = await _dataService.AddToLeaderboardAsync(userId, username, "game5", "Beginner", 45.0);
        var result3 = await _dataService.AddToLeaderboardAsync(userId, username, "game6", "Beginner", 55.0);
        ...
        var expertLeaderboard = await _dataService.GetLeaderboardAsync("Expert", 10);
        var beginnerLeaderboard = await _dataService.GetLeaderboardAsync("Beginner", 10);
